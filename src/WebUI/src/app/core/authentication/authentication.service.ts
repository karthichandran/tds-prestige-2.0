...
export class AuthenticationService {
  ...
  //    let httpParams = new HttpParams();
  //    httpParams = httpParams.set('username', loginContext.user);
  //    httpParams = httpParams.set('password', loginContext.password);
  //    httpParams = httpParams.set('grant_type', 'password');
  //    return this.http.post(`${environment.baseApiUrl}token`, encodeURI('username=' + loginContext.user + '&password=' + loginContext.password + '&grant_type=password')).pipe(map((data: any) => {
